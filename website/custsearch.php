    ...
    <div class="banner">
        <div class="navbar">
            ...
            <ul>
                ...
                <li><a href="./custsearch.php" id="Product">Search</a></li>
        ...
        <div class="form-center">
            <form action="./backend/usersearch.php" method="POST">
                ...
                <input type="number" name="Budget" placeholder="Upto-Budget" required><br><br>
